		...
		<div class="jumbotron" id="jumbotron_2">
			...
			<div class="swiper-container">
				<div class="swiper-wrapper" id="swiperImg" style="text-transform:uppercase;">
					<div class="swiper-slide"><span class="swipeModel">Scorpio</span><a href="rent1.php"><img src="images/Swiper/scorpio.png"></a></div>
				  	<div class="swiper-slide"><span class="swipeModel">Vitara Breza</span><a href="rent2.php"><img src="images/Swiper/brezza.jpg"></a></div>
				  	<div class="swiper-slide"><span class="swipeModel">Toyota Innova</span><a href="rent3.php"><img src="images/Swiper/innova.png"></a></div>
				  	<div class="swiper-slide"><span class="swipeModel">Mahindra Xuv</span><a href="rent4.php"><img src="images/Swiper/xuv300.jpg"></a></div>
				  	<div class="swiper-slide"><span class="swipeModel">Toyota Fortuner</span><a href="rent5.php"><img src="images/Swiper/fortuner.jpg"></a></div>
				  	<div class="swiper-slide"><span class="swipeModel">Honda City</span><a href="rent6.php"><img src="images/Swiper/city.jpg"></a></div>
				  	<div class="swiper-slide"><span class="swipeModel">Tata Nexon</span><a href="rent7.php"><img src="images/Swiper/nexon.jpg"></a></div>
				  	<div class="swiper-slide"><span class="swipeModel">Toyota Camry</span><a href="rent8.php"><img src="images/Swiper/camry.jpg"></a></div>
