...
<html lang="en-US">
	...
	<head>
		...
		<title>Toyota Fortuner 2016</title>
	...
	<div class="container.fluid">
		<div class="row">
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="10000">
  					...
  					<div class="carousel-inner">
    					<div class="carousel-item active">
      						<iframe width="100%" height="100%" src="https://360.hum3d.com/view/162513/" frameborder="0"></iframe>
    					</div>
    					<div class="carousel-item">
      						<img src="images/rent5/int.jpg" alt="Interior" width="100%" height="100%">
    					</div>
  					</div>
    				...
    				<div id="keyfeatures" class="tab-pane active">
    					<table class="table">
    						<tbody>
      							<tr>
        							<td>ARAI Mileage</td>
        							<td class="text-right">12.9 Kmpl</td>
     						 	</tr>
     						 	<tr>
        							<td>Engine Displacement</td>
        							<td class="text-right">2755cc</td>
     						 	</tr>
     						 	<tr>
        							<td>Max Power</td>
        							<td class="text-right">174.5bhp@3400rpm</td>
     						 	</tr>
    				...
    				<div id="rent" class="tab-pane fade">
    					<h5 >Select Colour</h5>
      					<ul id="colors" class="nav nav-tabs">
    						<li class="nav-item p-0 active"><a class="nav-link navlink2" data-toggle="tab" href="#white"><img src="images/rent5/superwhite.png" alt="SuperWhite"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#silver"><img src="images/rent5/silver.png" alt="SilverMetallic"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#bronze"><img src="images/rent5/bronze.png" alt="AvantGardeBronze"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#grey"><img src="images/rent5/grey.png" alt="GreyMetallic"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#black"><img src="images/rent5/black.png" alt="AltitudeBlack"></a></li>
  						</ul>

  						<div class="tab-content colors_spacing">
    						<div id="white" class="tab-pane fade in active">Super White</div>
    						<div id="silver" class="tab-pane fade">Silver Metallic</div>
    						<div id="bronze" class="tab-pane fade">Avant Garde Bronze</div>
    						<div id="grey" class="tab-pane fade">Grey Metallic</div>
  							<div id="black" class="tab-pane fade">Altitude Black</div>
						</div>
            ...
            <a class="custombtn" href='https://www.indiamart.com/proddetail/toyota-fortuner-rental-21677596562.html' target="_blank" rel="noopener noreferrer" style="padding-left: 120px; padding-right: 130px;">Contact Now</a>
...
<!-- The Modal -->
  <div class="modal fade" id="myModal">
    ...
    <div class="text-center" id="carmodel">Toyota Fortuner<br><span>2016<span></div>
		  <div id="rentprice" style="font-size: 1.7em; padding-top: 4px; ">₹43,999<span id="xsmall">/month</span></div>
