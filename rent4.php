...
<html lang="en-US">
	...
	<head>
		...
		<title>Mahindra XUV300 2019</title>
	...
	<div class="container.fluid">
		<div class="row">
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="10000">
  					...
  					<div class="carousel-inner">
    					<div class="carousel-item active">
      						<iframe width="100%" height="100%" src="https://360.hum3d.com/view/210973/" frameborder="0"></iframe>
    					</div>
    					<div class="carousel-item">
      						<img src="images/rent4/int.jpeg" alt="Interior" width="100%" height="100%">
    					</div>
  					</div>
    				...
    				<div id="keyfeatures" class="tab-pane active">
    					<table class="table">
    						<tbody>
      							<tr>
        							<td>ARAI Mileage</td>
        							<td class="text-right">20.0 Kmpl</td>
     						 	</tr>
     						 	<tr>
        							<td>Engine Displacement</td>
        							<td class="text-right">1497cc</td>
     						 	</tr>
     						 	<tr>
        							<td>Max Power</td>
        							<td class="text-right">115bhp@3750rpm</td>
     						 	</tr>
    				...
    				<div id="rent" class="tab-pane fade">
    					<h5 >Select Colour</h5>
      					<ul id="colors" class="nav nav-tabs">
    						<li class="nav-item p-0 active"><a class="nav-link navlink2" data-toggle="tab" href="#redrage"><img src="images/rent4/redrage.png" alt="RedRage"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#pearlwhite"><img src="images/rent4/pearlwhite.png" alt="PearlWhite"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#orange"><img src="images/rent4/sunburstorange.png" alt="SunburstOrange"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#dsatsilver"><img src="images/rent4/dsatsilver.png" alt="D'SatSilver"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#napoliblack"><img src="images/rent4/napoliblack.png" alt="NapoliBlack"></a></li>
  						</ul>

  						<div class="tab-content colors_spacing">
    						<div id="redrage" class="tab-pane fade in active">Red Rage</div>
    						<div id="pearlwhite" class="tab-pane fade">Pearl White</div>
    						<div id="orange" class="tab-pane fade">Sunburst Orange</div>
    						<div id="dsatsilver" class="tab-pane fade">D'Sat Silver</div>
  							<div id="napoliblack" class="tab-pane fade">Napoli Black</div>
						</div>
            ...
            <a class="custombtn" href='https://www.revv.co.in/open/bangalore/mahindra/xuv300/stock/confirm?c_id=5da84a13a547ddbaf0a4bf84' target="_blank" rel="noopener noreferrer" style="padding-left: 120px; padding-right: 130px;">Contact Now</a>
  ...
  <div class="modal fade" id="myModal">
    ...
    <div  class="text-center" id="carmodel">Mahindra XUV300<br><span>2019<span></div>
		<div id="rentprice" style="font-size: 1.7em; padding-top: 4px; ">₹27,099<span id="xsmall">/month</span></div>
		<a href="CarComparisonPage.php" role="button" class="links"> Compare With <br>Other Models</a>	
	
		<a href="rent5.php" role="button" class="btn btn-primary bold">toyota fortuner 2016</a>
