		...
		<div id="main-content" class="jumbotron">
			<div class="card-columns">
				<div class="card bg-light">
					<img class="card-img-top" src="images/buycars-page/mark2.jpg" alt="HM_Ambassador">
				</div>
			</div>
			<table>
				<tr>
					<th>Model</th>
					<td>Ambassador Mach 2</td>
				</tr>
				<tr>
					<th>Manufacturer</th>
			...
			<div id="phoneicon">
				...
				<p style="float:right;position:relative;bottom:100px;left:230px;font-family: 'devil_tail_-_personal_useRg';">Dealer Contact: +91 9895323007</p>
			</div>
		</div>
