		...
		<div id="main-content" class="jumbotron">
			<div class="card-columns">
				<div class="card bg-light">
					<img class="card-img-top" src="images/buycars-page/toyota_supra.jpg" alt="toyota_supra">
				</div>
			</div>
			<table>
				<tr>
				...
				<tr>
					<th>Location</th>
					<td>Banashankari Stage 3, Bengaluru</td>
				</tr>
				<tr>
					<th>Accidents</th>
					<td>0</td>
			...
			<div id="phoneicon">
				...
				<p style="float:right;position:relative;bottom:100px;left:230px;font-family: 'devil_tail_-_personal_useRg';">Dealer Contact: +91 8088159063</p>
			</div>
		</div>
