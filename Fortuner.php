		...
		<div id="main-content" class="jumbotron">
			<div class="card-columns">
				<div class="card bg-light">
					<img class="card-img-top" src="images/buycars-page/toyota_fortuner.jpeg" alt="Toyota_Fortuner">
				</div>
			</div>
			<table>
				<tr>
				...
				<tr>
					<th>Location</th>
					<td>Richmond Circle,Bengaluru</td>
				</tr>
				<tr>
					<th>Accidents</th>
					<td>0</td>
			...
			<div id="phoneicon">
				...
				<p style="float:right;position:relative;bottom:100px;left:230px;font-family: 'devil_tail_-_personal_useRg';">Dealer Contact: +91 8567684937</p>
			</div>
		</div>
