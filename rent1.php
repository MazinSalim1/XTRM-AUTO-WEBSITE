...
<html lang="en-US">
	...
	<head>
		...
		<title>Mahindra Scorpio 2015 S10</title>
			...
			<div class="col-sm-9">	
				<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="10000">
  					...
  					<ul class="carousel-indicators">
    					...
    					<li data-target="#myCarousel" data-slide-to="1" style="transition-delay:1s;"></li>
  					</ul>
  
  					<!-- The slideshow -->
  					<div class="carousel-inner">
    					<div class="carousel-item active">
      						<iframe width="100%" height="100%" src="https://360.hum3d.com/view/156259/" frameborder="0"></iframe>
    					</div>
    					<div class="carousel-item">
      						<img src="images/rent1/scorpio/int1.jpg" alt="Interior1" width="100%" height="100%">
    					</div>
  					</div>
    				...
    				<div id="keyfeatures" class="tab-pane active">
    					<table class="table">
    						<tbody>
      							<tr>
        							<td>ARAI Mileage</td>
        							<td class="text-right">16.36 kmpl</td>
     						 	</tr>
     						 	<tr>
        							<td>Engine Displacement</td>
        							<td class="text-right">2179cc</td>
     						 	</tr>
     						 	<tr>
        							<td>Max Power</td>
        							<td class="text-right">138.13bhp@3750rpm</td>
     						 	</tr>
    				...
    				<div id="rent" class="tab-pane fade">
    					<h5 >Select Colour</h5>
      					<ul id="colors" class="nav nav-tabs">
    						<li class="nav-item p-0 active"><a class="nav-link navlink2" data-toggle="tab" href="#royalblue"><img src="images/rent1/royalblue.png" alt="RoyalBlue"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#moltenred"><img src="images/rent1/moltenred.png" alt="MoltenRed"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#diamondwhite"><img src="images/rent1/diamondwhite.png" alt="DiamondWhite"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#mistsilver"><img src="images/rent1/mistsilver.png" alt="MistSilver"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#fieryblack"><img src="images/rent1/fieryblack.png" alt="FieryBlack"></a></li>
  						</ul>

  						<div class="tab-content colors_spacing">
    						<div id="royalblue" class="tab-pane fade in active">Royal Blue</div>
    						<div id="moltenred" class="tab-pane fade">Molten Red</div>
    						<div id="diamondwhite" class="tab-pane fade">Diamond White</div>
    						<div id="mistsilver" class="tab-pane fade">Mist Silver</div>
  							<div id="fieryblack" class="tab-pane fade">Fiery Black</div>
						</div>
						...
						<a class="custombtn" href='https://www.revv.co.in/open/bangalore/mahindra/scorpio/stock/confirm?c_id=5bfc339329f27d708b145018' target="_blank" rel="noopener noreferrer" style="padding-left: 120px; padding-right: 130px;">Contact Now</a>
 ...
 <!-- The Modal -->
  <div class="modal fade" id="myModal">
	...
	<footer class="panel-footer d-flex text-white justify-content-between">
		<a href="rent8.php" role="button" class="btn btn-primary bold">toyota camry se 2018</a>
    <div class="text-center" id="carmodel">Mahindra Scorpio<br><span>S10 2015<span></div>
		<div id="rentprice" style="font-size: 1.7em; padding-top: 4px; ">₹33,399<span id="xsmall">/month</span></div>
