...
<html lang="en-US">
	...
	<head>
		...
		<title>MARUTI Vitara Brezza 2016</title>
	...
	<div class="container.fluid">
		<div class="row">
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="10000">
  					...
  					<div class="carousel-inner">
    					<div class="carousel-item active">
      						<iframe width="100%" height="100%" src="https://360.hum3d.com/view/157929/" frameborder="0"></iframe>
    					</div>
    					<div class="carousel-item">
      						<img src="images/rent2/int.jpeg" alt="Interior" width="100%" height="100%">
    					</div>
  					</div>
    				...
    				<div id="keyfeatures" class="tab-pane active">
    					<table class="table">
    						<tbody>
      							<tr>
        							<td>ARAI Mileage</td>
        							<td class="text-right">24.3 Kmpl</td>
     						 	</tr>
     						 	<tr>
        							<td>Engine Displacement</td>
        							<td class="text-right">1248cc</td>
     						 	</tr>
     						 	<tr>
        							<td>Max Power</td>
        							<td class="text-right">90bhp@4000rpm</td>
     						 	</tr>
    				...
    				<div id="rent" class="tab-pane fade">
    					<h5 >Select Colour</h5>
      					<ul id="colors" class="nav nav-tabs">
    						<li class="nav-item p-0 active"><a class="nav-link navlink2" data-toggle="tab" href="#ceruleanblue"><img src="images/rent2/ceruleanblue.png" alt="CeruleanBlue"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#blazingred"><img src="images/rent2/blazingred.png" alt="BlazingRed"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#pearlarcticwhite"><img src="images/rent2/pearlarcticwhite.png" alt="PearlArcticWhite"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#premiumsilver"><img src="images/rent2/premiumsilver.png" alt="PremiumSilver"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#fieryyellow"><img src="images/rent2/fieryyellow.png" alt="FieryYellow"></a></li>
  						</ul>

  						<div class="tab-content colors_spacing">
    						<div id="ceruleanblue" class="tab-pane fade in active">Cerulean Blue with Pearl Arctic White</div>
    						<div id="blazingred" class="tab-pane fade">Blazing Red</div>
    						<div id="pearlarcticwhite" class="tab-pane fade">Pearl Arctic White</div>
    						<div id="premiumsilver" class="tab-pane fade">Premium Silver</div>
  							<div id="fieryyellow" class="tab-pane fade">Fiery Yellow</div>
						</div>
            ...
            <a class="custombtn" href='https://www.revv.co.in/open/bangalore/maruti/vitara-brezza/stock/confirm?c_id=5bfc339329f27d708b144ff8' target="_blank" rel="noopener noreferrer" style="padding-left: 120px; padding-right: 130px;">Contact Now</a>
  ...
  <div class="modal fade" id="myModal">
    ...
    <div  class="text-center" id="carmodel">Maruti Vitara<br><span>Brezza 2016<span></div>
		<div id="rentprice" style="font-size: 1.7em; padding-top: 4px; ">₹27,499<span id="xsmall">/month</span></div>
		<a href="CarComparisonPage.php" role="button" class="links"> Compare With <br>Other Models</a>	
	
		<a href="rent3.php" role="button" class="btn btn-primary bold">toyota innova crysta(th) 2017</a>
