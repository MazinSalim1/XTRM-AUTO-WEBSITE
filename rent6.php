...
<html lang="en-US">
	...
	<div class="container.fluid">
		<div class="row">
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="10000">
  					...
  					<div class="carousel-inner">
    					<div class="carousel-item active">
      						<iframe width="100%" height="100%" src="https://360.hum3d.com/view/189195/" frameborder="0"></iframe>
    					</div>
    					<div class="carousel-item">
      						<img src="images/rent6/int.jpg" alt="Interior" width="100%" height="100%">
    					</div>
  					</div>
    				...
    				<div id="keyfeatures" class="tab-pane active">
    					<table class="table">
    						<tbody>
     						 	...
     						 	<tr>
        							<td>Max Power</td>
        							<td class="text-right">97.9bhp@3600rpm</td>
     						 	</tr>
    				...
    				<div id="rent" class="tab-pane fade">
    					<h5 >Select Colour</h5>
      					<ul id="colors" class="nav nav-tabs">
    						<li class="nav-item p-0 active"><a class="nav-link navlink2" data-toggle="tab" href="#grey"><img src="images/rent6/grey.png" alt="LunarSilverMetallic"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#red"><img src="images/rent6/red.png" alt="RadiantRedMetallic"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#silver"><img src="images/rent6/silver.png" alt="ModernSilverMetallic"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#white"><img src="images/rent6/white.png" alt="PlatinumWhitePearl"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#bronze"><img src="images/rent6/bronze.png" alt="GoldenBrownMetallic"></a></li>
  						</ul>

  						<div class="tab-content colors_spacing">
    						<div id="grey" class="tab-pane fade in active">Lunar Silver Metallic</div>
    						<div id="red" class="tab-pane fade">Radiant Red Metallic</div>
    						<div id="silver" class="tab-pane fade">Modern Steel Metallic</div>
    						<div id="white" class="tab-pane fade">Platinum White Pearl</div>
  							<div id="bronze" class="tab-pane fade">Golden Brown Metallic</div>
						</div>
            ...
            <a class="custombtn" href='https://www.revv.co.in/open/bangalore/honda/city/stock/confirm?c_id=5bfc339329f27d708b145003' target="_blank" rel="noopener noreferrer" style="padding-left: 120px; padding-right: 130px;">Contact Now</a>
...
<!-- The Modal -->
  <div class="modal fade" id="myModal">
    ...
    <div class="text-center" id="carmodel">Honda City<br><span>2017<span></div>
		<div id="rentprice" style="font-size: 1.7em; padding-top: 4px; ">₹29,999<span id="xsmall">/month</span></div>
