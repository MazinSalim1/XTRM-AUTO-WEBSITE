...
<html lang="en-US">
	...
	<div class="container.fluid">
		<div class="row">
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="10000">
  					...
  					<div class="carousel-inner">
    					<div class="carousel-item active">
      						<iframe width="100%" height="100%" src="https://360.hum3d.com/view/180272/" frameborder="0"></iframe>
    					</div>
    					<div class="carousel-item">
      						<img src="images/rent7/int.jpg" alt="Interior" width="100%" height="100%">
    					</div>
  					</div>
    				...
    				<div id="keyfeatures" class="tab-pane active">
    					<table class="table">
    						<tbody>
      							<tr>
        							<td>ARAI Mileage</td>
        							<td class="text-right">21.5 Kmpl</td>
     						 	</tr>
     						 	<tr>
     						 	...
     						 	<tr>
        							<td>Max Power</td>
        							<td class="text-right">108.5bhp@4000rpm</td>
     						 	</tr>
    				...
    				<div id="rent" class="tab-pane fade">
    					<h5 >Select Colour</h5>
      					<ul id="colors" class="nav nav-tabs">
    						<li class="nav-item p-0 active"><a class="nav-link navlink2" data-toggle="tab" href="#blue"><img src="images/rent7/blue.png" alt="TectonicBlue"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#red"><img src="images/rent7/red.png" alt="FlameRed"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#white"><img src="images/rent7/white.png" alt="CalgaryWhite"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#silver"><img src="images/rent7/silver.png" alt="PureSilver"></a></li>
    						<li class="nav-item p-0"><a class="nav-link navlink2" data-toggle="tab" href="#grey"><img src="images/rent7/grey.png" alt="DaytonaGrey"></a></li>
  						</ul>

  						<div class="tab-content colors_spacing">
    						<div id="blue" class="tab-pane fade in active">Tectonic Blue</div>
    						<div id="red" class="tab-pane fade">Flame Red</div>
    						<div id="white" class="tab-pane fade">Calgary White</div>
    						<div id="silver" class="tab-pane fade">Pure Silver</div>
  							<div id="grey" class="tab-pane fade">Daytona Grey</div>
						</div>
            ...
            <a class="custombtn" href='https://www.mychoize.com/car-subscription-in-bengaluru/cars/car-booking-summary' target="_blank" rel="noopener noreferrer" style="padding-left: 120px; padding-right: 130px;">Contact Now</a>
  ...
  <div class="modal fade" id="myModal">
	...
	<footer class="panel-footer d-flex text-white justify-content-between">
		<a href="rent6.php" role="button" class="btn btn-primary bold">honda city 2017</a>
    <div class="text-center" id="carmodel">TATA Nexon<br><span>2017<span></div>
  <div id="rentprice" style="font-size: 1.7em; padding-top: 4px; ">₹26,499<span id="xsmall">/month</span></div>
