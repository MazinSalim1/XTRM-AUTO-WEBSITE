		...
		<div id="main-content" class="jumbotron">
			<div class="card-columns">
				<div class="card bg-light">
					<img class="card-img-top" src="images/buycars-page/compass.jpg" alt="jeep_compass">
				</div>
			</div>
			<table>
				<tr>
			...
			<div id="phoneicon">
				...
				<p style="float:right;position:relative;bottom:100px;left:230px;font-family: 'devil_tail_-_personal_useRg';">Dealer Contact: +91 8678756063</p>
			</div>
		</div>
